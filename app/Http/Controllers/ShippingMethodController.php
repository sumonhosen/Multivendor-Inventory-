...
class ShippingMethodController extends Controller
{
  ...
  public function saveShippingMethod(){
    if( Request::isMethod('post') && Session::token() == Request::get('_token') ){
      ...
      if(Request::get('_shipping_method_name') == 'save_options'){
        $enable_shipping = (Request::has('inputEnableShipping')) ? true : false;
        $display_mode    = Request::get('inputDisplayMode');
      ...
      elseif (Request::get('_shipping_method_name') == 'save_flat_rate') {
        $enable_method   = (Request::has('inputEnableFlatRate')) ? true : false;
        $method_title    = Request::get('inputFlatRateTitle');
        $method_cost     = Request::get('inputFlatRateCost');
      ...
      elseif (Request::get('_shipping_method_name') == 'save_free_shipping') {
        $enable_method   = (Request::has('inputEnableFreeShipping')) ? true : false;
        $method_title    = Request::get('inputFreeShippingTitle');
        $method_amount   = Request::get('inputFreeShippingOrderAmount');
      ...
      elseif (Request::get('_shipping_method_name') == 'save_local_delivery') {
        $enable_method   = (Request::has('inputEnableLocalDelivery')) ? true : false;
        $method_title    = Request::get('inputLocalDeliveryTitle');
        $fee_type        = Request::get('inputLocalDeliveryFeeType');
        $delivery_fee    = Request::get('inputLocalDeliveryDeliveryFee');
