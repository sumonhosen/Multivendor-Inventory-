...
/**
 * Get function for variation products price
 *
 * @param product id
 * @return double or integer number
 */
function get_variation_product_price($product_id)
{
  return GetFunction::variation_product_price($product_id);
}
...
{
  return GetFunction::create_price_view_for_list($price, $settings);
}
...
/**
 * Get razorpay API data
 *
 * @param null
 * @return array
 */
function get_razorpay_api_key()
{
  return GetFunction::razorpay_api_key();
}
 ...
 * @return string
 */
function vendor_name_by_oid($order_id)
{
  return GetFunction::vendor_name_by_oid($order_id);
}
 ...
 * @return boolean
 */
function check_permission_menu_heading($heading_slug, $user_permission_list){
  return GetFunction::permission_menu_heading($heading_slug, $user_permission_list);
}
...
function get_rest_api_data_by_token($token){
  return GetFunction::rest_api_data_by_token($token);
}

function create_unique_slug($table, $input_field){
  return GetFunction::generate_unique_slug($table, $input_field);
}

function is_installed(){
  return GetFunction::check_is_installed();
}

function has_admin(){
  return GetFunction::check_has_admin();
}

function install_config(){
  return GetFunction::get_install_config();
}

function post_unique_slug($table, $input_field){
  return GetFunction::generate_unique_slug($table, $input_field);
}

function is_all_tables_created(){
