<div id="single_product">
  <div class="container">
    ...
    <div id="product_description_bottom_tab" class="product-description-bottom-tab custom-feature-tab">
      <div class="row">
        <div class="col-12">  
          <ul class="nav nav-tabs">
            <li class="nav-item features-nav"><a <?php if(!old('comments_target')){?>class="nav-link active" <?php }?> href="#features" data-toggle="tab">{{ trans('frontend.features_label') }}</a></li>  
            <li class="nav-item"><a class="nav-link" style="display:none" href="#shippingInfo" data-toggle="tab">{{ trans('frontend.shipping_info_label') }}</a></li>

            @if($single_product_details['_product_enable_reviews'] == 'yes')
              <li class="nav-item review-nav" ><a class="nav-link <?php if(old('comments_target')){?>active <?php }?>" href="#reviews" data-toggle="tab">{{ trans('frontend.reviews_label') }} ({!! $comments_rating_details['total'] !!})</a></li>
            @endif
          ...
          <div class="tab-content">
            ...
            @if($single_product_details['_product_enable_reviews'] == 'yes')
            <div class="tab-pane <?php if(old('comments_target')){?>show active<?php }?>" id="reviews">
                <div class="product-reviews-content">
                  <div class="rating-box clearfix" style="display:none">
                      <div class="score-box">
