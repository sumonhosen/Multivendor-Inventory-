...
<div class="pageContent">
  <section class="content">
    <div class="container">
              ...
              <div class="tag-list">
                <ul>
                  @foreach($popular_tags_list as $tags)
                    <li>
                      <a href="{{ route('tag-single-page', $tags->slug) }}">
                        <!-- <i class="fa fa-angle-right"></i> -->
                       {{ ucfirst($tags->name) }}</a></li>
                  @endforeach
                </ul>
              </div>
            </div>
        ...
        <div id="productCenterColumn" class="col-xs-12 col-md-8">
          <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
              ...
              <img src="storage/app/public/images/shop-banner.jpg" class="product-banner"/>

                <!-- <div id="advertisement-right-carousel" class="carousel slide" data-ride="carousel">
                  <div class="carousel-inner">
                    <div class="carousel-item active">
                      <div class="text-center">
                        <img src="{{ asset('public/images/add-sample/girl.jpg') }}" alt="" class="d-block w-100" />
                      </div>
                    </div>
                    <div class="carousel-item">
                      <div class="text-center">
                        <img src="{{ asset('public/images/add-sample/sunglass.png') }}" alt="" class="d-block w-100" />
                      </div>
                    </div> 
                    <div class="carousel-item">
                      <div class="text-center">
                        <img src="{{ asset('public/images/add-sample/mobile.png') }}" alt="" class="d-block w-100" />
                      </div>
                    </div>
                  </div>
                  <div class="slider-control-main text-center">
              ...
              <div class="col-6">
                <div class="product-views pull-left">
                  @if($all_products_details['selected_view'] == 'grid')
                    <a class="active" href="{{ $all_products_details['action_url_grid_view'] }}" data-toggle="tooltip" data-placement="top" title="{{ trans('frontend.grid_label') }}"><i class="fa fa-th-large"></i></a> 
                  @else  
      ...
      <!-- <br><br> -->
      <div class="product-page-bottom" style="display:none">
        <div class="row">
