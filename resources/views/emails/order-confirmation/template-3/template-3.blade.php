          ...
          <td valign="top" align="left">
              ...
              <table cellspacing="0" cellpadding="0" border="0" style="background-color:white;border:0px solid #dcdcdc;border-radius:3px!important">
                <tbody>
                  <tr>
                    <td valign="top" align="left">
                      <table cellspacing="0" cellpadding="0" border="0" style="vertical-align:middle;font-family:&quot;Helvetica Neue&quot;,Helvetica,Roboto,Arial,sans-serif">
                        <tbody>
                          <tr>

                            <td style="padding-left: 20px;font-size: 15px;">
                              <h3>Thank you for your order!!!</h3>
                             <!--  <p>Your order has been received and being processed. your order details are shown below for your reference.</p> -->
                            </td>
                                    ...
                                    <td valign="top" style="">
                                      <div style="color:#737373;font-family:&quot;Helvetica Neue&quot;,Helvetica,Roboto,Arial,sans-serif;font-size:14px;line-height:150%;text-align:left">
                                        ...
                                        @if($_payment_method == 'bacs' || $_payment_method == 'cod')
                                          <p style="margin:0 0 16px">Pay upon Cash on delivery</p>
                                        @endif
                                        ...
                                        <h2 style="color:#3c8dbc;display:block;font-family:&quot;Helvetica Neue&quot;,Helvetica,Roboto,Arial,sans-serif;font-size:18px;font-weight:bold;line-height:130%;margin:16px 0 8px;text-align:left">{!! trans('email.order') !!} #{!! $_order_id !!}</h2>
                                        ...
                                        <h2 style="color:#3c8dbc;display:block;font-family:&quot;Helvetica Neue&quot;,Helvetica,Roboto,Arial,sans-serif;font-size:18px;font-weight:bold;line-height:130%;margin:16px 0 8px;text-align:left">Distributor Details</h2>
                                        <ul>
                                          <li>
...
<body>
<div marginheight="0" marginwidth="0">
  <div style="background-color:#{!! $data['new_order']['body_bg_color'] !!};margin:0;padding:70px 0 70px 0;width:100%" dir="ltr">
    <table width="100%" height="100%" cellspacing="0" cellpadding="0" border="0">
      <tbody>
        <tr>
          <td valign="top" align="center">
                        ...
                        <tbody>
                          <tr>
                            <td style="padding:36px 48px;display:block">
                              <h1 style="color:#ffffff;font-family:&quot;Helvetica Neue&quot;,Helvetica,Roboto,Arial,sans-serif;font-size:30px;font-weight:300;line-height:150%;margin:0;text-align:center">{!! $data['new_order']['email_heading'] !!}</h1>
                            </td>
                          </tr>
                        </tbody>
                      </table>
