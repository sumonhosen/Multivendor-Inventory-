    ...
    <div class="col-md-8">
      ...
      <div class="box box-solid">
        ...
        <div class="box-body">
          ...
          <input type="text" placeholder="{{ trans('admin.example_pages_placeholder') }}" class="form-control" name="page_title" id="seo_title" value="{{ $page_data_by_slug['post_title'] }}">
           ...
           <!--  <div class="form-group">  
              ...
              <div class="row">    
                ...
                <div class="col-md-12">
                  ...
                  <input type="text" class="form-control" name="seo_title" id="seo_title" placeholder="{{ trans('admin.seo_title_label') }}" value="{{ $page_data_by_slug['seo_title'] }}">
            ...
            <div class="form-group">
              ...
              <div class="row">   
                ...
                <div class="col-md-12">  
                  ...
                  <textarea id="seo_description" class="form-control" name="seo_description" placeholder="{{ trans('admin.seo_description_label') }}">{!! $page_data_by_slug['seo_description'] !!}</textarea>
            ...
            <div class="form-group">   
              ...
              <div class="row">   
                ...
                <div class="col-md-12">  
                  ...
                  <textarea id="seo_keywords" class="form-control" name="seo_keywords" placeholder="{{ trans('admin.seo_keywords_label') }}">{!! $page_data_by_slug['seo_keywords'] !!}</textarea>
