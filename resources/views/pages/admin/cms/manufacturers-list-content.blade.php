...
<div class="row">
  ...
  <div class="col-6">
    <div class="pull-right">
      <a href="{{ route('admin.add_manufacturers_content') }}" class="btn btn-primary pull-right btn-sm">Add Download</a>
    </div>  
  </div>
</div>
<br>
          ...
          <tbody>
            @if(count($manufacturerslist)>0)
              ...
              <tr>
                ...
                <td>
                	<a target="_blank" href="{{ get_image_url($row->brand_logo_img_url) }}"><img src="{{ url('/public/images/pdf.png') }}" alt="{{ basename ($row->brand_logo_img_url) }}"></a>
                </td>
                @else
