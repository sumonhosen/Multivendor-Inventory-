...
<?php //print_r($product_by_cat_id);die;?>
    <div class="col-xs-12 col-md-8">
      <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
          <div class="advertisement-right">
            <div style="padding-bottom:30px">
            <?php if($product_category['slug']=='personal-care'){?>
            	<img src="{{ asset('public/images/Category-Facecare.png') }}" alt="" class="d-block w-100" />
            <?php }elseif($product_category['slug']=='agri-care'){?>
            	<img src="{{ asset('public/images/Category-Agricare.png') }}" alt="" class="d-block w-100" />
            <?php }elseif($product_category['slug']=='oral-care'){?>
            	<img src="{{ asset('public/images/Category-Oralcare.png') }}" alt="" class="d-block w-100" />
            <?php }elseif($product_category['slug']=='health-care'){?>
            	<img src="{{ asset('public/images/Category-Healthcare.png') }}" alt="" class="d-block w-100" />
            <?php }?>
            </div>
              ...
              <div class="carousel-inner">
                <div class="carousel-item active" style="padding-bottom:30px">
                  <div class="text-center">
                    <a href=""><img src="{{ asset('public/images/product-banner.png') }}" alt="" class="d-block w-100" /></a>
                  </div>
                </div>
          ...
          <div class="col-6">
            <div class="product-views pull-left">
              @if($product_by_cat_id['selected_view'] == 'grid')
                <a class="active" href="{{ $product_by_cat_id['action_url_grid_view'] }}" data-toggle="tooltip" data-placement="top" title="{{ trans('frontend.grid_label') }}"><i class="fa fa-th-large"></i></a> 
              @else  
                <a href="{{ $product_by_cat_id['action_url_grid_view'] }}" data-toggle="tooltip" data-placement="top" title="{{ trans('frontend.grid_label') }}"><i class="fa fa-th-list"></i></a> 
              @endif
