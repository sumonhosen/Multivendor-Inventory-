...
@section('content')
<div id="testimonial_details" class="container new-container testimonial_details">
  <div class="row">
    <div class="col-md-12">
    ...
    <div class="col-md-12 text-center pt-3">
      <a href="<?php echo url("/testimonials");?>" class="btn btn-sm testimonials-read">VIEW MORE TESTIMONIALS</a>
