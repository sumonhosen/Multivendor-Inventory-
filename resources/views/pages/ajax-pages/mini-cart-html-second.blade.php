<a href="" class="main show-mini-cart no-pad-right" data-id="2"> <span class="d-none d-md-inline">{!! trans('frontend.menu_my_cart') !!}</span> <span class="fa fa-shopping-cart"></span> <span class="cart-count"><span id="total_count_by_ajax">{!! Cart::count() !!}</span></span></a>
