<aside class="main-sidebar">
  <section class="sidebar">
    <ul class="sidebar-menu">
      ...
      @if(Request::is('admin/banner/list') || Request::is('admin/banner/add') || Request::is('admin/banner/update/*'))
        <li class="active treeview">
      @else
       <li class="treeview">
      @endif
          <a href="#">
            <i class="fa fa-image"></i> <span>Banner Manager</span> <i class="fa fa-angle-left pull-right"></i>
          </a>
          <ul class="treeview-menu">
              <li><a href="{{ route('admin.banner_list_content') }}"><i class="fa fa-table"></i>View All</a></li>
              <li><a href="{{ route('admin.banner_add') }}"><i class="fa fa-table"></i> Add New</a></li>
          </ul>
        </li>
      ...
      @if(Request::is('admin/manufacturers/list') || Request::is('admin/manufacturers/add') || Request::is('admin/manufacturers/update/*'))
        <li class="active treeview">
          <a href="#">
            <i class="fa fa-download"></i> <span>Downloads</span> <i class="fa fa-angle-left pull-right"></i>
          </a>
          <ul class="treeview-menu">
            @if(in_array('brands_list_access', $user_permission_list))
              @if(Request::is('admin/manufacturers/list'))
                <li class="active"><a href="{{ route('admin.manufacturers_list_content') }}"><i class="fa fa-table"></i> Downloads</a></li>
              @else
                <li><a href="{{ route('admin.manufacturers_list_content') }}"><i class="fa fa-table"></i> Downloads</a></li>
              @endif
            @endif
            ...
            @if(in_array('add_edit_delete_brands', $user_permission_list))
              @if(Request::is('admin/manufacturers/add') || Request::is('admin/manufacturers/update/*'))
                <li class="active"><a href="{{ route('admin.add_manufacturers_content') }}"><i class="fa fa-plus-square-o"></i>Add Download</a></li>
              @else
                 <li><a href="{{ route('admin.add_manufacturers_content') }}"><i class="fa fa-plus-square-o"></i>Add Download</a></li>
              @endif
            @endif
          </ul>
        </li>
      ...
      <li class="treeview">
          <a href="#">
            <i class="fa fa-gift"></i> <span>Distributor Offer</span> <i class="fa fa-angle-left pull-right"></i>
          </a>
          <ul class="treeview-menu">
              <li><a href="{{ route('admin.add_offer') }}"><i class="fa fa-plus-square-o"></i>Create New</a></li>
              <li><a href="{{ route('admin.all_offers') }}"><i class="fa fa-plus-square-o"></i>View All</a></li>
          </ul>
        </li>
      ...
      <li class="treeview">
          <a href="#">
            <i class="fa fa-shopping-cart"></i> <span>Stock</span> <i class="fa fa-angle-left pull-right"></i>
          </a>
          <ul class="treeview-menu">
              <li><a href="{{ route('admin.product_stock_list', $product_parm) }}"><i class="fa fa-plus-square-o"></i>Stock Alert</a></li>
          </ul>
          <ul class="treeview-menu">
            <li><a href="{{ route('admin.inventory_log', $product_parm) }}"><i class="fa fa-plus-square-o"></i>Inventory Log</a></li>
        </ul>
        </li>

      <li class="treeview">
          <a href="#">
            <i class="fa fa-file-text-o"></i> <span>Distributor Report</span> <i class="fa fa-angle-left pull-right"></i>
          </a>
          <ul class="treeview-menu">
              <li><a href="{{ route('admin.create-distributor-report') }}"><i class="fa fa-plus-square-o"></i>Create</a></li>
          </ul>
        </li>

      @if(check_permission_menu_heading('sales', $user_permission_list))
      ...
      @if(in_array('manage_orders_list', $user_permission_list))
          ...
          <li class="treeview">
            <a href="#">
              <i class="fa fa-file-text-o"></i> <span>{!! trans('admin.orders') !!}</span> <i class="fa fa-angle-left pull-right"></i>
            </a>
            <ul class="treeview-menu">

                <li class="">
                    <a href="{{ route('admin.shop_current_date_orders_list') }}">
                      <i class="fa fa-file-text-o"></i> <span>Today's Orders</span>
                    </a>
                  </li>

                 <li class="">
                    <a href="{{ route('admin.shop_orders_list') }}?type=all_order">
                      <i class="fa fa-file-text-o"></i> <span>All Orders</span>
                    </a>
                  </li>

                   <li class="">
                    <a href="{{ route('admin.shop_orders_list') }}?type=completed">
                      <i class="fa fa-file-text-o"></i> <span>Completed Orders</span>
                    </a>
                  </li>

                  <li class="">
                    <a href="{{ route('admin.shop_orders_list') }}?type=on-hold">
                      <i class="fa fa-file-text-o"></i> <span>On Hold Orders</span>
                    </a>
                  </li>

                   <li class="">
                    <a href="{{ route('admin.shop_orders_list') }}?type=cancelled">
                      <i class="fa fa-file-text-o"></i> <span>Blocked Orders</span>
                    </a>
                  </li>
      ...
      @if(check_permission_menu_heading('vendors', $user_permission_list) && !$sidebar_data['is_vendor_login'])
      <!--<li class="sidebar-vendor-title">{!! trans('admin.sidebar_vendor_title') !!}</li>-->
      <li class="sidebar-vendor-title">Manage Distributors</li>
      @endif
      ...
      @if(!$sidebar_data['is_vendor_login'])
        ...
        <li class="active treeview">
          <a href="#">
            ...
            <i class="fa fa-handshake-o"></i> <span>Distributors</span> <i class="fa fa-angle-left pull-right"></i>
          </a>
          <ul class="treeview-menu">
            @if(in_array('vendors_list_access', $user_permission_list))
              ...
              <li class="active"><a href="{{ route('admin.vendors_list_content') }}"><i class="fa fa-table"></i> Distributors List</a></li>
              @else
              <!--<li><a href="{{ route('admin.vendors_list_content') }}"><i class="fa fa-table"></i> {!! trans('admin.admin_menu_vendors_list_label') !!}</a></li>-->
              <li><a href="{{ route('admin.vendors_list_content') }}"><i class="fa fa-table"></i> Distributors List</a></li>
              @endif
            @endif
      ...
      @if(check_permission_menu_heading('config', $user_permission_list))
        ...
        @if(Request::is('admin/payment-method/options') || Request::is('admin/payment-method/direct-bank') || Request::is('admin/payment-method/cash-on-delivery') || Request::is('admin/payment-method/paypal') || Request::is('admin/payment-method/stripe') || Request::is('admin/payment-method/two-checkout'))
          <li class="active treeview">
            ...
            <ul class="treeview-menu">
              ...
              @if(Request::is('admin/payment-method/razorpay'))
                <li class="active"><a href="{{ route('admin.payment_method_razorpay_content') }}"><i class="fa fa-inr"></i> {!! trans('admin.razorpay') !!}</a></li>
              @else
                <li><a href="{{ route('admin.payment_method_razorpay_content') }}"><i class="fa fa-inr"></i> {!! trans('admin.razorpay') !!}</a></li>
              @endif
            </ul>
          </li>
        @else
      ...
      @if(check_permission_menu_heading('features', $user_permission_list))
      ...
      @if(in_array('manage_extra_features_access', $user_permission_list))
        @if(Request::is('admin/extra-features/product-compare-fields') || Request::is('admin/extra-features/color-filter') || Request::is('admin/rest-api-token') || Request::is('admin/rest-api-token/*'))
          <li class="active treeview">
            <a href="#">
            ...
            <ul class="treeview-menu">
              ...
              @if(isset($user_data['user_role_slug']) && $user_data['user_role_slug'] == 'administrator')
                @if(Request::is('admin/rest-api-token') || Request::is('admin/rest-api-token/*'))
                <li class="active"><a href="{{ route('rest-api-token.index') }}"><i class="fa fa-exchange"></i> {!! __('admin.restapitoken.menu.label') !!}</a></li>
                @else
                <li><a href="{{ route('rest-api-token.index') }}"><i class="fa fa-exchange"></i> {!! __('admin.restapitoken.menu.label') !!}</a></li>
                @endif
              @endif
            </ul>
          </li>
