          ...
          <div class="col-xs-12 col-sm-12 col-md-6 grid-view">
            <div class="hover-product">
              <div class="hover">
                ...
                <a href ="{{ route('details-page', $products->slug) }}"><img  src="{{ get_image_url( $products->image_url ) }}" alt="{{ basename( get_image_url( $products->image_url ) ) }}" /></a>
                @else
                <a href ="{{ route('details-page', $products->slug) }}"><img  src="{{ default_placeholder_img_src() }}" alt="" /></a>
                @endif
              ...
              <div class="single-product-bottom-section">
                ...
                <h3><a href ="{{ route('details-page', $products->slug) }}">{!! $products->title !!}</a></h3>
