...
Route::group(['namespace' => 'Auth'], function () {
  ...
  Route::get( '/distributor/login', [
    'uses' => 'LoginController@goToFrontendDisLoginPage',
    'as'   => 'distributor-login-page'
  ]);

  Route::post( '/distributor/login', [
    'uses' => 'LoginController@sendQuickOTP',
    'as'   => 'otp.distributor'
  ]);

  // Route::post( '/distributor/login', [
  //   'uses' => 'LoginController@postFrontendDisLogin',
  //   'as'   => 'distributor-login-post'
  // ]);

 Route::get( '/distributor/otp', [
    'uses' => 'LoginController@goToFrontendOtpPage',
    'as'   => 'otp-validate'
  ]);

 Route::post( '/distributor/validate-otp', [
    'uses' => 'LoginController@postFrontendDisLogin',
    'as'   => 'distributor-login-post'
  ]);
  ...
  Route::get( '/registration-page', [
    'uses' => 'RegisterController@registrationProcessAll',
...
Route::group(['prefix' => 'admin'], function () {
 ...
 //offer
  ...
  Route::get('offer/add', [
    'uses' => 'OfferController@AddContent',
    'as'   => 'admin.add_offer'
  ])->middleware('verifyLoginPage', 'admin', 'sufficientPermission');
  ...
  Route::get('inactive-offer', [
    'uses' => 'OfferController@change_status',
    'as'   => 'admin.change_status'
  ]);

  Route::get('offer/list', [
    'uses' => 'OfferController@ListContent',
    'as'   => 'admin.all_offers'
  ])->middleware('verifyLoginPage', 'admin', 'sufficientPermission');
  ...
  Route::post('dashboard/send-admin-email', [
  ...
  Route::get('product/list/{author_id}', [
    ...
    Route::get('product/stock-alert/{author_id}', [
    'uses' => 'ProductsController@productListContentStock',
    'as'   => 'admin.product_stock_list'
  ])->middleware('verifyLoginPage', 'admin', 'sufficientPermission');

  Route::get('product/inventory_log/{author_id}', [
    'uses' => 'ProductsController@productInventoryLog',
    'as'   => 'admin.inventory_log'
  ])->middleware('verifyLoginPage', 'admin', 'sufficientPermission');
  ...
  Route::get('payment-method/razorpay', [
    'uses' => 'PaymentMethodController@paymentMethodRazorpayContent',
    'as'   => 'admin.payment_method_razorpay_content'
  ])->middleware('verifyLoginPage', 'admin', 'sufficientPermission');
  ...
  Route::get('orders', [
   ...
   Route::post('orders/date-search', [
    'uses' => 'OrderController@Orders_by_date_range',
    'as'   => 'admin.order_by_date'
  ]);

   Route::post('orders/order-search', [
    'uses' => 'OrderController@Orders_search',
    'as'   => 'admin.order_search'
  ]);
  ...
  Route::get('banner/list', [
    'uses' => 'CMSController@bannerListContent',
    'as'   => 'admin.banner_list_content'
  ])->middleware('verifyLoginPage', 'admin',) ;

  Route::get('banner/add', [
    'uses' => 'CMSController@bannerAddContent',
    'as'   => 'admin.banner_add'
  ])->middleware('verifyLoginPage', 'admin');


  Route::post('banner/add', [
    'uses' => 'CMSController@saveBannerData',
    'as'   => 'admin.save_banner_content'
  ]);

  Route::get('banner/update/{id}', [
    'uses' => 'CMSController@bannerUpdateContent',
    'as'   => 'admin.update_banner_content'
  ])->middleware('verifyLoginPage', 'admin');
...
Route::post('banner/update/{id}', [
  ...
  Route::get('order/invoice_email/{order_id}', [
    'uses' => 'OrderController@OrderInvoiceEmail',
    'as'   => 'admin.order_invoice_email'
  ])->middleware('verifyLoginPage', 'admin', 'sufficientPermission');

  Route::resource('rest-api-token', 'Admin\RestApiTokenController')->except(['show']);
});
...
Route::group(['prefix' => 'admin'], function () {
  ...
  Route::post('payment-method/razorpay', [
    'uses' => 'PaymentMethodController@savePaymentData',
    'as'   => 'admin.save_razorpay_content'
  ]);
...
Route::get('/export_stock_products', [
  'uses' => 'ProductsController@manageStockExportProducts',
  'as'   => 'export-low-stock-products'
]);


Route::post('/export_distributor_report', [
  'uses' => 'ProductsController@manageDisributorExportReport',
  'as'   => 'export-distributor-report'
]);

Route::get('/create_distributor_report', [
  'uses' => 'ProductsController@create_distributor_report',
  'as'   => 'admin.create-distributor-report'
]);
...
Route::post('/ajax/user-status-change', [
  'uses' => 'Admin\AdminAjaxController@userStatusChange',
...
Route::post('/ajax/contact-with-vendor-from-admin', [
  'uses' => 'Admin\AdminAjaxController@contactWithVendorFromAdminEmail',
  'as'   => 'contact-with-vendor-from-admin-email'
]);
...
Route::post('/ajax/add-to-cart-offer', [
  'uses' => 'Frontend\FrontendAjaxController@productAddToCartOffer',
  'as'   => 'product-add-to-cart-offer'
]);
...
Route::post('/contact-send-mail', [
  'uses' => 'Frontend\FrontendManagerController@contactWithSendEmail',
...
Route::get( '/product/affiliation_details/{aff_slug}/{aff_id}', [
  'uses' => 'Frontend\FrontendManagerController@productSingleAffContent',
  'as'   => 'aff_details'
]);
...
Route::get('/local/pickup', [
  'uses' => 'Frontend\FrontendManagerController@localPickup',
  'as'   => 'local-pickup'
]);
...
$router->post( '/razorpay-checkout-button', [
  'uses' => 'CheckoutController@razorpayCheckoutButton',
  'as' => 'razorpay-checkout-button'
]);
...
Route::get('checkout/razorpaysuccess', [
  'uses' => 'CheckoutController@razorpaysuccess',
  'as'   => 'razorpaysuccess'
]);
...
Route::get( '/downloads', [
  'uses' => 'Frontend\FrontendManagerController@downloadListPageContent',
  'as'   => 'testimonial-list-page'
]);

Route::get( '/testimonials', [
  'uses' => 'Frontend\FrontendManagerController@testimonialListPageContent',
  'as'   => 'testimonial-list-page'
]);
...
Route::get( '/categories/{blog_cat_slug}', [
...
Route::get('/contact-us', [
  'uses' => 'Frontend\FrontendManagerController@contactUsPageContent',
  'as'   => 'contact-us'
]);
...
Route::group(['prefix' => 'user', 'namespace' => 'Frontend'], function () {
  ...
  Route::get( 'account/bv-points', [
    'uses' => 'UserAccountManageController@vendorAccountPointsPageContent',
    'as'   => 'my-points'
  ])->middleware('userAdmin', 'verifyLoginPage');

  Route::get( 'account/my-offers', [
    'uses' => 'UserAccountManageController@OffersForVendors',
    'as'   => 'my-offers'
  ])->middleware('userAdmin', 'verifyLoginPage');
  ...
  Route::get( 'account/affiliation_points', [
    'uses' => 'UserAccountManageController@userAccountaffiliationPoint',
    'as'   => 'affiliation_points'
  ])->middleware('userAdmin', 'verifyLoginPage');

  Route::get( 'account/aff_pro_points', [
    'uses' => 'UserAccountManageController@affProPoints',
    'as'   => 'aff_pro_points'
  ])->middleware('userAdmin', 'verifyLoginPage');
